...
if (!args[0]) {
    const ghembed = new Discord.RichEmbed()
        .setColor(0xFF0000)
        .setTitle(`${message.author.username} abraçou-se a si mesmo...! (weirdo)`)
...
if (!message.mentions.members.first().user.username === message.isMentioned(message.author)) {
    const hembed = new Discord.RichEmbed()
        .setColor(0xFF0000)
        .setTitle(`${message.author.username} deu um abraço a ${message.mentions.members.first().user.username}. <a:Cat_hug:573232582075088916> How sweet!`)
